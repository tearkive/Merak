<?php   
    ...
    if (!isset($_SESSION["token"])) {
        $_SESSION["modinf"]["Tel"] = $_POST['tel'];
        $_SESSION["modinf"]["correo"] = $_POST['correo'];
    }
        $correo = $_SESSION["modinf"]["correo"]; 
...
<body>
    <div role="article" aria-roledescription="email" lang="en" class="contenedor">
                    ...
                    <table role="presentation" class="tabla-interna">
                        ...
                        <tr>
                            <td class="parte-dos">
                                ...
                                <p>Se solicitó un código de verificación de cambio de información de contacto. Copie su código:</p>
                            </td>
                        </tr>
                        <tr>
                            <td class="parte-tres">
        ...
        if(mail($correo, 'Codigo para actualización de información', $mensaje,$cabeceras)){
