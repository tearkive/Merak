...
<body>
    ...
    <main>
        <div class="cita">
            <form action="../../Controllers/actualizarCitaPro.php" method="POST">
                <div class="programa-cita-header">
					<h2>Reprogramación de citas</h2>
                    <p>En Merak, estamos comprometidos con el bienestar de los pacientes y queremos que su experiencia
                        sea lo más flexible y cómoda posible.</p>
					<p>Elige el nuevo horario de tu paciente. </p>
				</div>
                <div class="programar-cita">
                    <div class="programa-cita">
                        <div class="programa-cita-elem">
                            ...
                            <input type="text" name="idUsuario" hidden value="<?php echo $_GET['idUs']; ?>">
